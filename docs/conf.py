...
description = "Dispatch decorator framework"
author = "Qiskit addons team"
language = "en"
release = metadata_version("coheriq")
...
modindex_common_prefix = ["coheriq."]
...
def linkcode_resolve(domain, info):
    ...
    if module is None or "coheriq" not in module_name:
        return None
    ...
    try:
        ...
        return None
    if full_file_name is None or "/coheriq/" not in full_file_name:
        return None
    file_name = full_file_name.split("/coheriq/")[-1]
    ...
    return f"https://github.com/Qiskit/coheriq/tree/{GITHUB_BRANCH}/coheriq/{file_name}{linespec}"
